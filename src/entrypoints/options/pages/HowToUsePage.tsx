...
export function HowToUsePage() {
  return (
    <main className="p-10 text-sm">
      <h1 className="text-center text-2xl font-bold">사용법</h1>
      <div className="mt-2 text-center">아래의 설명을 따라 차근차근 설정하시면 됩니다.</div>
      <section className="mx-auto mt-10 max-w-2xl space-y-8">
        ...
        <div role="alert" className="alert-soft alert">
          <p>
