...
export function ProfileForm() {
  ...
  return (
    <form className="space-y-2 p-4" onSubmit={onSubmit}>
      <h3 className="ml-2 text-lg font-bold">{t("add_profile")}</h3>

      <div>
        <label className="input w-full rounded-b-none border-b-0">
          <FontAwesomeIcon className="h-4 w-4" icon={faUser} />
          <input id="name" name="name" placeholder={t("full_name")} required type="text" />
        </label>

        <fieldset className="flex">
          <select className="select flex-1 rounded-none border-r-0" id="carrier" name="carrier">
          ...
          <label className="input flex-2 gap-2 rounded-none">
        ...
        <label className="input w-full gap-2 rounded-none border-y-0">
        ...
        <fieldset className="flex">
          <select
            className="select flex-2 rounded-t-none rounded-br-none border-r-0"
            id="foreigner"
            name="foreigner"
          >
          ...
          <select className="select flex-3 rounded-none border-r-0" id="gender" name="gender">
            <option value="-1">{t("gender")}</option>
            <option value="1">{t("male")}</option>
            <option value="2">{t("female")}</option>
          </select>

          <select className="select flex-4 rounded-t-none rounded-bl-none" id="way" name="way">
